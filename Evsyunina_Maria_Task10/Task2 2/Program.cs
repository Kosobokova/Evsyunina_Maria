...
namespace ConsoleApplication1
{
    ...
    public class Person
    {
        ...
        {
            // say hello
            Console.WriteLine($"[Hello {otherPerson}! - {Name} said]");
        }

        public void SayGoodBye(string otherName)
        {
            // say bye
            Console.WriteLine($"[Goodbye {otherName}! - {Name} said]");
        }
    }
}
...
namespace ConsoleApplication1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            List<Person> workers = new List<Person> { vanya, petya, borya };
            Office office1 = new Office(workers);
